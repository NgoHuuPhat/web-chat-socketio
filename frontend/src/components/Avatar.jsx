...
const Avatar = ({ userInfo, onAvatarClick, size = 'large', className = '' }) => {
    ...
    return (
      <div className="relative group">
        <div className={`rounded-full overflow-hidden bg-gradient-to-br from-pink-400 via-purple-500 to-blue-500 flex items-center justify-center text-white font-bold transition-all duration-500 ${sizeClasses[size]} ${className}`}>
          {userInfo.avatar && (
            <img 
              src={userInfo.avatar} 
              alt="Profile" 
